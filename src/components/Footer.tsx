      ...
      <div className="container-narrow px-4 md:px-8 py-14 grid md:grid-cols-2 lg:grid-cols-5 gap-10">
        <div className="lg:col-span-2">
          <div className="flex items-center gap-2.5 mb-4">
            <div className="w-11 h-11 rounded-md bg-primary-foreground flex items-center justify-center">
              <img src={logo} alt="Aegis Global Recruitment Agency logo" loading="lazy" width={36} height={36} className="w-9 h-9 object-contain" />
            </div>
          ...
          <div className="mt-5 space-y-1.5 text-sm text-primary-foreground/75">
            ...
            <a href="tel:+254716534393" className="block hover:text-primary transition">+254 716 534 393</a>
            <a href="mailto:linkedin@mywork.co.ke" className="block hover:text-primary transition">linkedin@mywork.co.ke</a>
          </div>
        </div>

        {cols.map((c) => (
          <div key={c.title}>
            <div className="font-semibold text-sm uppercase tracking-wider mb-4 text-primary">{c.title}</div>
