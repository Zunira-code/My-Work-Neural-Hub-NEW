...
const DestinationsSection = () => {
  return (
    <section id="destinations" className="section bg-ink text-primary-foreground">
      <div className="container-narrow">
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-12 items-start">
          <div>
            <div className="text-xs uppercase tracking-[0.2em] text-primary font-bold mb-3">Where We Place</div>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {regions.map((r, i) => (
              <motion.div key={r.region}
                ...
                <h3 className="font-display font-semibold text-lg text-primary mb-3">{r.region}</h3>
